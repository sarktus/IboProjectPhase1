...
namespace BusinessStandard.Api.Resources
{
    public class BlobStorageService
    {
        ...
        public BlobStorageService()
        {
            ...
            this.accessKey = configuration["Data:ConnectionStrings:BlobConnections"];//.GetConnectionString("Data:ConnectionStrings:BlobConnections");
        }
        ...
        public async Task DeleteBlobData(string fileUrl)
        {
            ...
            string strContainerName = "blobstorage";
